...
export const PRESETS: MaterialPreset[] = [
  ...
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [8.62, 11.45, 16.24, 20.52, 24.81, 29.11],
    hkls: ['001', '010', '100', '110', '200', '210'],
    description: 'Recombinant human stem cell crystallin protein featuring highly ordered beta-pleated sheets, serving as an advanced crystallographic profile for cellular scaffolds and organoid tracking.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 10.42 Å, b = 15.31 Å, c = 5.24 Å, β = 95.8°',
    database: 'CSD',
    databaseId: 'SCRYST01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [4.50, 6.80, 9.10, 13.60, 18.20, 22.80],
    hkls: ['100', '110', '200', '220', '310', '400'],
    description: 'High-purity vertebrate eye lens gamma-crystallin protein specimen. Characterized by stable hydrophobic beta-barrel fold layers with excellent solution stability controls.',
    category: 'Biomaterial',
    crystalSystem: 'Tetragonal',
    spaceGroup: 'P43212 (No. 96)',
    latticeParams: 'a = 19.62 Å, c = 38.85 Å',
    database: 'CSD',
    databaseId: '1GCR'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [7.20, 10.80, 14.40, 18.00, 21.60, 25.20],
    hkls: ['001', '002', '003', '004', '005', '006'],
    description: 'Vertebrate core molecular heat shock alpha-A-crystallin protein complex structure, vital for maintaining cellular refraction stability.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P63/m (No. 176)',
    latticeParams: 'a = 14.20 Å, c = 24.60 Å',
    database: 'CSD',
    databaseId: 'ACRYST02'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [5.10, 8.20, 12.30, 15.40, 20.60, 24.70],
    hkls: ['100', '110', '200', '210', '220', '310'],
    description: 'Major vertebrate lens structural beta-B2-crystallin protein. Shows stable dimeric assemblies preserving low-scattering characteristics.',
    category: 'Biomaterial',
    crystalSystem: 'Orthorhombic',
    spaceGroup: 'P212121 (No. 19)',
    latticeParams: 'a = 17.30 Å, b = 21.55 Å, c = 34.20 Å',
    database: 'CSD',
    databaseId: 'BCRYST03'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [6.20, 9.30, 12.40, 15.50, 18.60, 21.70],
    hkls: ['110', '200', '211', '220', '310', '321'],
    description: 'Avian and reptile eye-lens specific delta-crystallin, structurally related to argininosuccinate lyase.',
    category: 'Biomaterial',
    crystalSystem: 'Cubic',
    spaceGroup: 'I432 (No. 211)',
    latticeParams: 'a = 28.50 Å',
    database: 'CSD',
    databaseId: 'DCRYST04'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [2.89, 5.78, 8.67, 11.56, 14.45, 17.34],
    hkls: ['001', '002', '003', '004', '005', '006'],
    ...
    latticeParams: 'a = 12.50 Å, c = 30.60 Å',
    database: 'CSD',
    databaseId: 'COLLAG01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [1.85, 3.70, 5.55, 9.25, 12.95, 18.50],
    hkls: ['100', '200', '300', '500', '700', '1000'],
    ...
    latticeParams: 'a = 47.88 Å, b = 9.85 Å, c = 5.15 Å',
    database: 'CSD',
    databaseId: 'KERATN01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [10.20, 14.80, 18.90, 20.30, 24.20, 28.50],
    hkls: ['020', '110', '021', '200', '121', '220'],
    ...
    crystalSystem: 'Orthorhombic',
    spaceGroup: 'P212121 (No. 19)',
    latticeParams: 'a = 9.38 Å, b = 17.40 Å, c = 6.98 Å',
    database: 'CSD',
    databaseId: 'SILKF01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [3.15, 5.46, 6.30, 9.54, 11.20, 15.80],
    hkls: ['100', '110', '200', '300', '310', '410'],
    ...
    latticeParams: 'a = 82.50 Å, c = 34.00 Å',
    database: 'CSD',
    databaseId: 'INSULN01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [2.80, 4.20, 5.60, 8.40, 11.20, 14.00],
    hkls: ['001', '002', '003', '004', '005', '006'],
    description: 'Polycrystalline bovine serum albumin transport protein specimen used as a reference point in biological small-angle scattering (SAXS).',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 60.10 Å, b = 81.30 Å, c = 95.20 Å, β = 90.0°',
    database: 'CSD',
    databaseId: 'BSABIO01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [5.80, 8.12, 10.20, 12.30, 16.40, 20.50],
    hkls: ['110', '200', '211', '310', '400', '420'],
    description: 'Tetragonal hen egg-white lysozyme crystal. Used as the global benchmark protein crystal for calibrating biological XRD detectors.',
    category: 'Biomaterial',
    crystalSystem: 'Tetragonal',
    spaceGroup: 'P43212 (No. 96)',
    latticeParams: 'a = 79.10 Å, c = 37.90 Å',
    database: 'CSD',
    databaseId: 'LYSOZ01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [3.80, 7.60, 11.40, 15.20, 19.00, 22.80],
    hkls: ['100', '200', '300', '400', '500', '601'],
    ...
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 64.60 Å, b = 31.10 Å, c = 34.80 Å, β = 105.5°',
    database: 'CSD',
    databaseId: 'MYOGLB01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [3.20, 6.40, 9.60, 12.80, 16.00, 19.20],
    hkls: ['100', '200', '300', '400', '500', '600'],
    description: 'Recombinant extracellular matrix (ECM) laminin-crystallin hybrid protein specimen. Organizes into a highly structured sheet-like hexagonal network suitable for cellular scaffolding and basement membrane modeling.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P63 (No. 173)',
    latticeParams: 'a = 31.40 Å, c = 55.60 Å',
    database: 'CSD',
    databaseId: 'ECMLAM01'
  },
  {
    ...
    formula: 'C40H80NO8P',
    wavelength: 1.5406,
    peaks: [4.20, 6.30, 8.40, 12.60, 16.80],
    hkls: ['001', '002', '003', '005', '006'],
    description: 'Crystallized dipalmitoylphosphatidylcholine (DPPC) lipid bilayer lattice. Demonstrates solid-gel phase sub-lattice alignment used to calibrate biomembrane structural dynamics scans.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 9.20 Å, b = 10.15 Å, c = 42.60 Å, β = 93.4°',
    database: 'CSD',
    databaseId: 'DPPCLI01'
  },
  {
    ...
    formula: 'C43H76O2',
    wavelength: 1.5406,
    peaks: [3.80, 5.70, 7.60, 11.40, 15.20],
    hkls: ['001', '002', '003', '004', '005'],
    description: 'Highly ordered organic crystal phase of cholesteryl palmitate ester. Crucial reference marker in modeling atherosclerotic calcified streaks and cell storage membrane boundaries.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 12.60 Å, b = 9.15 Å, c = 48.20 Å, β = 91.8°',
    database: 'CSD',
    databaseId: 'CHOLPL01'
  },
  {
    ...
    formula: 'C27H46O · H2O',
    wavelength: 1.5406,
    peaks: [5.18, 10.36, 15.54, 17.10, 21.80],
    hkls: ['001', '002', '003', '101', '110'],
    ...
    crystalSystem: 'Triclinic',
    spaceGroup: 'P1 (No. 1)',
    latticeParams: 'a = 12.35 Å, b = 12.42 Å, c = 34.15 Å, α = 91.8°, β = 98.1°, γ = 100.3°',
    database: 'CSD',
    databaseId: 'CHLMON01'
  },
  {
    ...
    formula: 'C39H79N2O6P',
    wavelength: 1.5406,
    peaks: [4.12, 6.18, 8.24, 12.36, 20.50],
    hkls: ['001', '002', '003', '004', '005'],
    description: 'Highly ordered solid gel crystalline phase of milk-derived sphingomyelin. Essential for examining lipid-raft domain boundaries.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 9.80 Å, b = 10.45 Å, c = 44.10 Å, β = 95.2°',
    database: 'CSD',
    databaseId: 'SPHING01'
  },
  {
    ...
    formula: 'C16H32O2',
    wavelength: 1.5406,
    peaks: [6.10, 12.20, 18.30, 21.50, 24.10],
    hkls: ['001', '002', '003', '110', '200'],
    description: 'Monoclinic B-form crystal structure of palmitic acid. Shows classic aliphatic chain packing with tilted dimer layers.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/c (No. 14)',
    latticeParams: 'a = 9.42 Å, b = 5.00 Å, c = 35.60 Å, β = 97.4°',
    database: 'CSD',
    databaseId: 'PLMTAC01'
  },
  {
    ...
    formula: 'C18H36O2',
    wavelength: 1.5406,
    peaks: [5.45, 10.90, 16.35, 21.70, 24.20],
    hkls: ['002', '004', '006', '110', '200'],
    ...
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/a (No. 14)',
    latticeParams: 'a = 5.61 Å, b = 7.36 Å, c = 51.50 Å, β = 98.6°',
    database: 'CSD',
    databaseId: 'STEACD02'
  },
  {
    ...
    formula: 'C12H24O2',
    wavelength: 1.5406,
    peaks: [8.15, 12.10, 16.30, 21.12, 23.40],
    hkls: ['002', '003', '004', '110', '200'],
    ...
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/c (No. 14)',
    latticeParams: 'a = 9.52 Å, b = 4.95 Å, c = 27.20 Å, β = 96.8°',
    database: 'CSD',
    databaseId: 'LURACD01'
  },
  {
    ...
    formula: 'C44H84NO8P',
    wavelength: 1.5406,
    peaks: [3.75, 5.62, 7.50, 11.25, 15.00],
    hkls: ['001', '002', '003', '004', '005'],
    ...
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 10.45 Å, b = 9.85 Å, c = 48.60 Å, β = 92.5°',
    database: 'CSD',
    databaseId: 'DOPCLI01'
  },
  {
    ...
    formula: 'C37H72NO8P',
    wavelength: 1.5406,
    peaks: [4.05, 6.08, 8.10, 12.15, 16.20],
    hkls: ['001', '002', '003', '004', '005'],
    description: 'Crystallized palmitoyloleoylphosphatidylethanolamine (POPE) phospholipid arrangement. Used for resolving structural curvatures and lipid-protein matching parameters.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 9.60 Å, b = 10.30 Å, c = 46.10 Å, β = 94.1°',
    database: 'CSD',
    databaseId: 'POPELI01'
  },
  {
    ...
    formula: 'C8H9NO2',
    wavelength: 1.5406,
    peaks: [12.12, 15.54, 18.23, 20.40, 23.45],
    hkls: ['011', '110', '11-1', '020', '120'],
    description: 'Crystalline Form I of acetaminophen (paracetamol). The thermodynamically stable monoclinic configuration at room temperature.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/a (No. 14)',
    latticeParams: 'a = 12.93 Å, b = 9.40 Å, c = 7.10 Å, β = 115.9°',
    database: 'CSD',
    databaseId: 'PARACM01'
  },
  {
    ...
    formula: 'C13H18O2',
    wavelength: 1.5406,
    peaks: [6.08, 12.18, 16.55, 18.78, 22.25],
    hkls: ['002', '004', '110', '112', '200'],
    description: 'Crystalline phase of Ibuprofen (Form I). Demonstrates highly distinct, close-packed aliphatic molecular dimer geometries.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/c (No. 14)',
    latticeParams: 'a = 14.66 Å, b = 7.89 Å, c = 10.73 Å, β = 99.4°',
    database: 'CSD',
    databaseId: 'IBUPRF01'
  },
  {
    ...
    formula: 'C9H8O4',
    wavelength: 1.5406,
    peaks: [7.85, 15.63, 19.12, 22.45, 27.15],
    hkls: ['100', '200', '111', '012', '220'],
    description: 'Form I acetylsalicylic acid crystalline structure, utilizing custom salicylic dimer chains which exhibit clear thermal expansion profiles.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/c (No. 14)',
    latticeParams: 'a = 11.37 Å, b = 6.54 Å, c = 11.38 Å, β = 95.8°',
    database: 'CSD',
    databaseId: 'ACSALC01'
  },
  {
    ...
    formula: 'C15H12N2O',
    wavelength: 1.5406,
    peaks: [7.92, 12.10, 15.15, 18.64, 24.90],
    hkls: ['011', '101', '111', '120', '201'],
    description: 'Anticonvulsant active pharmaceutical ingredient crystalline phase; critical standard in drug polymorphism research.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/c (No. 14)',
    latticeParams: 'a = 7.53 Å, b = 11.15 Å, c = 13.92 Å, β = 92.8°',
    database: 'CSD',
    databaseId: 'CBMZPN03'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [5.15, 10.30, 15.45, 18.20, 20.80],
    hkls: ['001', '002', '003', '101', '110'],
    description: 'Crystalline phenomenomethylpenicillin potassium salt standard displaying rigid beta-lactam backbones with layered potassium channels.',
    category: 'Biomaterial',
    crystalSystem: 'Orthorhombic',
    spaceGroup: 'P212121 (No. 19)',
    latticeParams: 'a = 6.32 Å, b = 10.20 Å, c = 34.30 Å',
    database: 'CSD',
    databaseId: 'PENCIL01'
  },
  {
    ...
    formula: 'C19H16ClNO4',
    wavelength: 1.5406,
    peaks: [8.38, 11.62, 16.65, 21.82, 26.60],
    hkls: ['001', '010', '100', '111', '210'],
    description: 'Highly stable gamma-polymorph crystalline indomethacin standard. Commonly used to examine structural baselines of solid dispersions.',
    category: 'Biomaterial',
    crystalSystem: 'Triclinic',
    spaceGroup: 'P-1 (No. 2)',
    latticeParams: 'a = 9.30 Å, b = 10.95 Å, c = 11.05 Å, α = 92.7°, β = 94.3°, γ = 107.5°',
    database: 'CSD',
    databaseId: 'INDMET01'
  },
  {
    ...
    formula: 'C8H10N4O2',
    wavelength: 1.5406,
    peaks: [11.85, 13.20, 24.10, 26.85, 28.15],
    hkls: ['100', '011', '200', '120', '220'],
    description: 'Anhydrous beta-phase caffeine crystalline alkaloid. Features dynamic planar CH...O hydrogen boundaries with regular stacked purine motifs.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'C2/c (No. 15)',
    latticeParams: 'a = 14.85 Å, b = 9.75 Å, c = 7.30 Å, β = 97.2°',
    database: 'CSD',
    databaseId: 'CAFFEI01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [7.15, 11.35, 14.30, 18.12, 21.85],
    hkls: ['100', '011', '110', '111', '020'],
    description: 'Emergency opioid receptor antagonist crystal. Highly ordered salt-hydrate form vital for molecular reversal of toxic levels of narcotics in first-responder medicine.',
    category: 'Biomaterial',
    crystalSystem: 'Orthorhombic',
    spaceGroup: 'P212121 (No. 19)',
    latticeParams: 'a = 10.25 Å, b = 14.65 Å, c = 26.35 Å',
    database: 'CSD',
    databaseId: 'NALXHC01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [5.82, 9.45, 11.64, 16.85, 20.32],
    hkls: ['001', '010', '101', '110', '111'],
    description: 'Highly crystalline oral codeine salt reference phase, demonstrating dense networks of proton-sharing amine and phosphate groupings.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 14.15 Å, b = 6.85 Å, c = 21.40 Å, β = 98.4°',
    database: 'CSD',
    databaseId: 'CODPHS01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [8.42, 12.60, 15.15, 19.22, 23.85],
    hkls: ['100', '110', '020', '111', '211'],
    description: 'Monoclinic local anesthetic reference standard showing classic chloride-anchored alkyl-amine hydrogen bridges under room conditions.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/c (No. 14)',
    latticeParams: 'a = 12.10 Å, b = 15.42 Å, c = 9.80 Å, β = 103.5°',
    database: 'CSD',
    databaseId: 'LIDOHC01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [6.12, 10.45, 12.24, 15.65, 19.80],
    hkls: ['100', '110', '200', '120', '211'],
    description: 'Cholinolytic muscarinic acetylcholine receptor blocker. Important clinical antidote standard used to counteract anticholesterase and organophosphate poisonings.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
    latticeParams: 'a = 11.90 Å, b = 15.80 Å, c = 12.40 Å, β = 97.4°',
    database: 'CSD',
    databaseId: 'ATRNSP01'
  },
  {
    ...
    formula: 'C6H8O6',
    wavelength: 1.5406,
    peaks: [10.45, 14.22, 17.60, 20.28, 25.32],
    hkls: ['010', '100', '011', '110', '111'],
    description: 'Vitamin C reference crystal featuring intensive intermolecular hydrogen-bonded systems that govern antioxidant electron transfer.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21 (No. 4)',
  ...
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [7.80, 11.70, 15.60, 23.40, 31.20],
    hkls: ['100', '110', '200', '220', '310'],
    description: 'Polar ice-binding glycoprotein template that forces surrounding water into a highly periodic, non-freezing liquid crystalline film to prevent cell lysis.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P63 (No. 173)',
    latticeParams: 'a = 11.40 Å, c = 22.80 Å',
    database: 'CSD',
    databaseId: 'ICEGLY01'
  },
  {
    ...
    formula: '34H2O + Guest',
    wavelength: 1.5406,
    peaks: [12.80, 16.20, 21.50, 24.80, 28.40],
    hkls: ['111', '200', '220', '311', '222'],
    description: 'Hexagonal Structure H clathrate hydrate consisting of a 34-water-molecule hosting network for bulkier bio-organic guest substances.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P6/mmm (No. 191)',
    latticeParams: 'a = 12.20 Å, c = 9.95 Å',
    database: 'CSD',
    databaseId: 'ICECLT01'
  },
  {
    ...
    formula: 'D2O',
    wavelength: 1.5406,
    peaks: [23.10, 24.60, 26.20, 33.90, 40.80],
    hkls: ['100', '002', '101', '102', '110'],
    description: 'Crystalline deuteurated heavy water ice Ih standard exhibiting minor anisotropic shift differences compared to light water ice.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P63/mmc (No. 194)',
    latticeParams: 'a = 4.51 Å, c = 7.35 Å',
    database: 'CSD',
    databaseId: 'DEUTIC01'
  },
  {
    ...
    formula: 'CO2',
    wavelength: 1.5406,
    peaks: [27.42, 31.80, 45.61, 54.10, 56.62],
    hkls: ['111', '200', '220', '311', '222'],
    description: 'Solid carbon dioxide Phase I (dry ice) crystallized at low temperatures. Linear CO2 symmetric crystal array.',
    category: 'Biomaterial',
    crystalSystem: 'Cubic',
    spaceGroup: 'Pa-3 (No. 205)',
    latticeParams: 'a = 5.62 Å',
    database: 'CSD',
    databaseId: 'CO2DRY01'
  },
  {
    ...
    formula: 'CO2 · 5.75H2O',
    wavelength: 1.5406,
    peaks: [12.72, 17.95, 22.04, 25.48, 28.53],
    hkls: ['110', '200', '211', '220', '310'],
    description: 'Structure I carbon dioxide clathrate hydrate. Guest CO2 molecules trapped inside hydrogen-bonded water host cages.',
    category: 'Biomaterial',
    crystalSystem: 'Cubic',
    spaceGroup: 'Pm-3n (No. 223)',
    latticeParams: 'a = 12.03 Å',
    database: 'CSD',
    databaseId: 'CO2CLH01'
  },
  {
    ...
    formula: 'N2',
    wavelength: 1.5406,
    peaks: [27.32, 31.68, 45.44, 53.89, 56.40],
    hkls: ['111', '200', '220', '311', '222'],
    description: 'Low-temperature cubic solid nitrogen alpha phase stable below 35.6 K with ordered molecular orientations.',
    category: 'Biomaterial',
    crystalSystem: 'Cubic',
    spaceGroup: 'Pa-3 (No. 205)',
    latticeParams: 'a = 5.64 Å',
    database: 'CSD',
    databaseId: 'N2ALPH01'
  },
  {
    ...
    formula: 'N2',
    wavelength: 1.5406,
    peaks: [25.37, 27.00, 37.13, 44.52, 52.88],
    hkls: ['100', '002', '101', '102', '110'],
    description: 'Hexagonal intermediate solid phase of molecular nitrogen preserving strong close-packed rotational disorder.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P63/mmc (No. 194)',
    latticeParams: 'a = 4.05 Å, c = 6.60 Å',
    database: 'CSD',
    databaseId: 'N2BETA02'
  },
  {
    ...
    formula: 'N',
    wavelength: 1.5406,
    peaks: [39.46, 48.78, 56.90, 71.39, 84.62],
    hkls: ['110', '200', '211', '220', '310'],
    description: 'Cubic gauche single-bonded polymeric nitrogen phase. Extrapolates to incredibly high covalent network density.',
    category: 'Biomaterial',
    crystalSystem: 'Cubic',
    spaceGroup: 'I213 (No. 199)',
    latticeParams: 'a = 3.21 Å',
    database: 'CSD',
    databaseId: 'CGNITR01'
  },
  {
    ...
    wavelength: 1.5406,
    peaks: [12.75, 17.98, 22.08, 25.52, 28.58],
    hkls: ['110', '200', '211', '220', '310'],
    description: 'Co-occupied mixed carbon dioxide and nitrogen hydrate crystal. Models gas storage dynamics under polar glaciers.',
    category: 'Biomaterial',
    crystalSystem: 'Cubic',
    spaceGroup: 'Pm-3n (No. 223)',
    latticeParams: 'a = 12.01 Å',
    database: 'CSD',
    databaseId: 'CO2N2C01'
  },
  {
    ...
    formula: 'C3H3N3O3',
    wavelength: 1.5406,
    peaks: [14.92, 19.85, 24.31, 28.50, 31.25],
    hkls: ['002', '110', '11-2', '200', '112'],
    description: 'Symmetric heterocyclic nitrogen-rich triazine standard. Planar hydrogen-bonded graphite-like network structure.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'C2/c (No. 15)',
    latticeParams: 'a = 7.74 Å, b = 6.73 Å, c = 11.91 Å, β = 130.7°',
    database: 'CSD',
    databaseId: 'CYACID01'
  },
  {
    ...
    formula: 'C3H6N6',
    wavelength: 1.5406,
    peaks: [17.65, 21.43, 26.24, 28.91, 33.40],
    hkls: ['100', '011', '11-1', '200', '120'],
    description: 'Highly structured amine derivative of s-triazine. Extensive hydrogen-bonding properties with wide industrial applications.',
    category: 'Biomaterial',
    crystalSystem: 'Monoclinic',
    spaceGroup: 'P21/a (No. 14)',
    latticeParams: 'a = 10.54 Å, b = 7.48 Å, c = 7.28 Å, β = 112.9°',
    database: 'CSD',
    databaseId: 'MELAMN01'
  },
  {
    ...
    formula: 'CH4N2O',
    wavelength: 1.5406,
    peaks: [22.25, 29.31, 35.48, 37.81, 41.60],
    hkls: ['110', '101', '200', '111', '210'],
    description: 'Highly pure organic crystalline urea reference. Classic template for guest-host channels and organic crystal engineering.',
    category: 'Biomaterial',
    crystalSystem: 'Tetragonal',
    spaceGroup: 'P-421m (No. 113)',
    latticeParams: 'a = 5.65 Å, c = 4.70 Å',
    database: 'CSD',
    databaseId: 'UREAXX01'
  },
  {
    ...
    formula: 'C3N4',
    wavelength: 1.5406,
    peaks: [15.90, 27.75, 31.95, 39.80, 48.20],
    hkls: ['100', '110', '200', '101', '111'],
    description: 'Hexagonal superhard beta-carbon nitride phase showcasing intense covalent C-N bonding network properties equivalent to diamond.',
    category: 'Biomaterial',
    crystalSystem: 'Hexagonal',
    spaceGroup: 'P63/m (No. 176)',
    latticeParams: 'a = 6.43 Å, c = 2.40 Å',
    database: 'CSD',
    databaseId: 'BC3N4X01'
  },
  {
